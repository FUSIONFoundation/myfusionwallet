...
var ensCtrl = function ($scope, $sce, walletService, $rootScope) {
        ...
        $scope.setReceiveAmountMakeSwap = function () {
            ...
            let makeSendSwapRateBN = new Decimal($scope.convertToString($scope.makeSendSwapRate));
        ...
        $scope.setMinimumMakes = function () {
            if ($scope.makeMinumumSwap <= 0 || $scope.makeMinumumSwap == '' || $scope.makeSendAmount <= 0 || $scope.makeReceiveAmount <= 0) {
                return
            }
