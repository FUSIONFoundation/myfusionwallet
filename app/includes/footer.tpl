        ...
        <div class="container">
            ...
            <div class="row container-fluid">
                ...
                <div class="col-md-3">
                    ...
                    <div class="pt-2">
                    <a class="p-1" href=""><i class="fa fa-2x fa-twitter" aria-hidden="true"></i></a>
                    <a class="p-1" href=""><i class="fa fa-2x fa-telegram" aria-hidden="true"></i></a>
                    <a class="p-1" href=""><i class="fa fa-2x fa-medium" aria-hidden="true"></i></a>
                    <a class="p-1" href=""><i class="fa fa-2x fa-globe" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        </div>
