                ...
                <article class="block no-shadow" ng-hide="wallet.type=='addressOnly'">
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-md-6 text-left p-0">
                            ...
                            <div class="display-web-inline-block pt-2"
                    ...
                    <div class="col-md-8 pl-2 pr-2">
                       <p>Number of fills determines the minimum amount someone can take in your swap. 1 fill would mean only the full swap can be taken. </p>
                    </div>
                    <div class="col-md-12 p-0">
