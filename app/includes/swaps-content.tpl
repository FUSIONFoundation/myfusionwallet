                        ...
                        <a>
                            ...
                            <div class="col" click-out="!sendDropDown">
                                {{selectedSendAsset}} <span
                                        ...
                                        ng-show="selectedSendVerified && selectedSendAsset !== 'All Assets'"><img src="./images/verified.svg" height="14px"
                                                                            width="14px"/></span>
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-md-6 text-left p-0">
                            ...
                            <div class="col-md-12 display-web-inline-block pt-2"
                                ...
                                <a class="small-blue" ng-click="makeSendAmount = selectedAssetBalance"><strong>{{selectedAssetBalance}}</strong> available</a>
                            </div>
