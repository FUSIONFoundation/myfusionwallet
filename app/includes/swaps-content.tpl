            ...
            <div class="panel-body">
                ...
                <table class="table" ng-show="openMakeSwaps != 0 && !showLoader">
                    ...
                    >
                        ...
                        <td class="text-left" ng-click="swapInformationModalOpen(asset.swap_id)">{{asset.time}} <br> <span
                        ...
                        <td class="text-right" ng-click="swapInformationModalOpen(asset.swap_id)">
                            <strong>{{asset.minswap.toFixed(4)}}</strong> {{asset.fromAssetSymbol}}
                        </td>
                        <td class="float-right text-right">
                            <div ng-hide="asset.owned == false">
        ...
        <div class="panel panel-default" ng-show="showSwapMarket === true && showOpenTakes === false">
            <div class="panel-body">
                ...
                <table class="table" ng-show="!showLoader">
                    ...
                    <tbody>
                    <tr ng-repeat="asset in swapsList | orderBy:'-timePosix':sortKey:reverse |filter:searchSwapMarket | startFrom:currentPage*pageSize | limitTo:pageSize track by $index">
                        <td class="text-left"
                            ng-click="swapInformationModalOpen(asset.swap_id)"
                        >
                            <span class="gray-bg-2 font-size-12 p-1 targes-border">
                        ...
                        <td class="text-right"
                            ng-click="swapInformationModalOpen(asset.swap_id)"><strong>{{asset.swapratetaker.toFixed(4)}}</strong> <span
                                    class="font-size-12">{{asset.toAssetSymbol}}</span></td>
                        <td class="text-right"
                            ng-click="swapInformationModalOpen(asset.swap_id)"><strong>{{asset.minswaptaker.toFixed(4)}}</strong> <span
                                    class="font-size-12">{{asset.toAssetSymbol}}</span></td>
                        <td class="float-right text-right">
                            <div ng-hide="asset.owned == false">
                                <button class="btn btn-sm btn-white m-0" ng-click="recallModal(asset.swap_id)">
