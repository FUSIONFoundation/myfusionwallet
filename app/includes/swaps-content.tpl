            ...
            <div class="panel-body">
                ...
                <table class="table" ng-show="!showLoader">
                    ...
                    <tr ng-repeat="asset in swapsList | orderBy:sortKey:reverse |filter:searchSwapMarket | startFrom:currentPage*pageSize | limitTo:pageSize track by $index">
                        ...
                        <td class="text-right"><strong>{{asset.swapratetaker.toFixed(3)}}</strong> <span class="font-size-12">{{asset.toAssetSymbol}}</span></td>
                        <td class="text-right"><strong>{{asset.minswaptaker.toFixed(3)}}</strong> <span class="font-size-12">{{asset.toAssetSymbol}}</span></td>
                        <td class="float-right text-right">
                            <div ng-hide="asset.owned == false">
            ...
            <section class="modal-content">
                <article class="block" ng-hide="wallet.type=='addressOnly'">
                    ...
                    <div class="row gray-border-bottom p-2 mb-2 mt-2">
                        ...
                        <div class="col-md-8">
                            <div class="float-right">
                                <span class="float-left"><input type="number" class="form-control m-0 mt-1" ng-model="takeAmountSwap"
                                                          min="1"
