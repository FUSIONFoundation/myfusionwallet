        ...
        <div class="panel panel-default" ng-show="showSwapMarket === false && showOpenTakes === false">
            <div class="panel-body">
                ...
                <table class="table" ng-show="openMakeSwaps != 0 && !showLoader">
                    ...
                    <tr class="small-gray-table">
                        <th class="text-left" scope="col"></th>
                        <th class="text-left" scope="col" ng-click="sortOpenMakes('time')">Time Initiated</th>
                        <th class="text-right" scope="col" ng-click="sortOpenMakes('fromAmountCut')">Send</th>
                        <th class="text-right" scope="col" ng-click="sortOpenMakes('toAmountCut')">Receive</th>
                        <th class="text-right" scope="col" ng-click="sortOpenMakes('swaprate')">Swap Rate</th>
                        <th class="text-right" scope="col" ng-click="sortOpenMakes('minswap')">Fill Size</th>
                        <th class="text-right" scope="col" class="float-right">Actions</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <div class="col-md-12 p-0">
                        ...
                        <div class="col-md-4 p-1">
                            <input type="number" class="form-control m-0 mt-1"
                                   ...
                                   ng-change="setReceive()" placeholder="Fills"> <span
                                    class="small-gray-text">of {{takeDataFront.swapSize}}</span>
                        </div>
                    </div>
