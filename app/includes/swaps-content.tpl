...
<article class="block p-0" ng-hide="wallet.type=='addressOnly'">
    <div class="col-md-12">
        <div class="col-md-5 float-left">
            <div class="sendAssetBalanceAvailable w-100">
                <span class="small-gray-text">Public Address </span><span class="small-gray-text text-fusion">{{walletAddress}}</span>
            </div>
        </div>
        <div class="col-md-5 float-left">
            <div class="sendAssetBalanceAvailable w-100">
                <span class="small-gray-text">Short Address </span><span class="small-gray-text text-fusion">{{addressNotation}}</span>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12 p-2 swap-border">
        ...
        <div class="col-md-1 text-center">
            ...
            <br>
            <button class="btn btn-sm btn-secondary" ng-click="switchAsset()"><i class="fa fa-exchange" aria-hidden="true"></i>
            </button>
        </div>
