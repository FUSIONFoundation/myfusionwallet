    ...
    <div class="row swap-market-new">
        ...
        <div class="col-md-12">
            <div class="make-swap-section-new" ng-show="showSwapMarket === true">
                <div class="action-grp">
                    ...
                    <div class="action-item">
                        ...
                        >
                            ...
                            <div class="ad-search-grp">
                                ...
                                <div
                                        ng-repeat="asset in assetList | filter:searchSendAsset | filter: {verified:'true'} track by $index">
                    ...
                    <img class="switch-btn" src="./images/you-send-new.svg" ng-click="switchAsset()" width="32px" height="32px" />
                    <div class="action-item">
                        <div class="action-title">YOU RECEIVE</div>
                        <div> you send link here </div>
                    </div>
                </div>
        ...
        <div class="col-md-12 p-2 bg-body make-swap-section" ng-show="showSwapMarket === true">
            <div class="col-md-3 text-left mr-0">
                ...
                <div class="dropdown-menu dropdown-menu fusion-text-14 p-2 higher-min-width" ng-show="sendDropDown && false"
                     tw-click-outside="closeSendDropDown()" ignore-if="!sendDropDown">
                ...
                <article class="block no-shadow reset-modal" ng-hide="wallet.type=='addressOnly'">
                    ...
                    <div class="limit-width">
                        ...
                        <p class="ms-confirmed-description" ng-show="transactionStatus !== 'Success'">Your swap has been
                            sent and ahould be confirmed with the next block. You may close this receipt at any time or
                        ...
                        <div class="price-section">
                            ...
                            <div class="price-row">
                                ...
                                <div class="price-value"
                                     ng-show="selectedSendContract !== '0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe'">{{makeSendAmount}}
                                    <span class="currency"
                                          ng-show="selectedSendContract !== '0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe'">{{assetToSendConfirm}}</span>
                                    <span ng-show="selectedSendContract !== '0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe'"> : </span>{{makeReceiveAmount}}
                                    <span class="currency">{{selectedReceiveAssetSymbol}}</span>
                                </div>
                            </div>
