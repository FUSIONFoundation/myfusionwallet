...
<header class="{{curNode.name}} {{curNode.service}} {{curNode.service}} nav-index-{{gService.currentTab}}"
    ...
    <div class="header-container p-0">
                ...
                <span class="dropdown dropdown-node">
                        <a tabindex="0"
                           ...
                           ng-click="dropdownMenu = !dropdownMenu">
                                       <i class="fa fa-bars" aria-hidden="true"></i> My Wallet
                        </a>
                        <ul class="dropdown-menu fusion-text-14 p-2" ng-show="dropdownMenu">
                            <span class="small-gray-text">Apps</span>
                            <li class="p-2">My Wallet</li>
                            <li class="p-2">Asset Locking</li>
                            <li class="p-2">Autobuy Stake</li>
                            <li class="p-2">Block Explorer</li>
                            <li class="p-2">Swap Exchange</li>
                        </ul>
                    </span>
                <div class="align-self-center">
      ...
      <ul class="dropdown-menu" ng-show="dropdownNode">
        ...
        <nav role="navigation" aria-label="main navigation" class="nav-container overflowing pl-3 pr-3">
