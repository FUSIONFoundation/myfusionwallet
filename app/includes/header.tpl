                ...
                <div class="nav-scroll">
                    <ul class="nav-inner">
                        ...
                        <li class="nav-item" \
                            ...
                            ng-click="tabClick(7)">
                            <a tabindex="0">
                                <img src="images/tab-icon-wallet-active.svg" ng-show="7==gService.currentTab" width="24" height="24">
                                <img src="images/tab-icon-wallet-inactive.svg" ng-show="7!=gService.currentTab" width="24" height="24">
                                Quantum Swaps
                            </a>
                        </li>
                        }
