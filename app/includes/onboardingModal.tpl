        ...
        <div class="modal-content">
              ...
              Welcome to My Fusion Wallet (MFW)
                    ...
                    <div class="alert-yellow col-md-12">
                        <p class="intro-p">
                            ...
                            MFW is only an interface that provides users with a simple mechanism for creating and accessing
                            Fusion PSN wallets and interacting with the PSN network. As with any cryptocurrency wallet, it is
                            important that you understand the risks associated with using, storing and sending digital assets.
                            If you execute an incorrect, transaction, swap, time-lock or any other function it cannot be
                            reversed. If your private keys are lost or stolen we cannot recover them for you or return stolen
                            funds. If you are new to the blockchain ecosystem, we advise that you engage in a thorough due
                    ...
                    <div class="text-center">
                        ...
                        <div class="col-md-12 p-2 text-center">
                            <i class="fa fa-circle ball-active"   aria-hidden="true" ng-click="setOnboardStatus(1)"></i>
                            <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(2)"></i>
                            <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(3)"></i>
                            <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(4)"></i>
                            <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(5)"></i>
                            <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(6)"></i>
                            <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(7)"></i>
                        </div>
                    </div>
            ...
            <span>
              Asset Creation
                    ...
                    <p class="float-left fusion-text-14 intro-p col-md-12">
                        MyFusionWallet supports the seamless creation of new digital assets without the need for any
                        programming. These assets can be stored, exchanged, time-locked or swapped on the FUSION Payable
                        Stage Network.
                    </p>

                    <div class="col-md-12 p-2 text-center">
                        <i class="fa fa-circle ball-inactive"   aria-hidden="true" ng-click="setOnboardStatus(1)"></i>
                        <i class="fa fa-circle ball-active" aria-hidden="true" ng-click="setOnboardStatus(2)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(3)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(4)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(5)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(6)"></i>
            ...
            <span>
              Asset Lock-in
                    ...
                    <p class="float-left fusion-text-14 intro-p col-md-12">FUSION’s Lock-in function enables assets from
                        various blockchains to enter the FUSION ecosystem and access the complete functionality of the
                        FUSION Protocol. </p>

                    <div class="col-md-12 p-2 text-center">
                        <i class="fa fa-circle ball-inactive"   aria-hidden="true" ng-click="setOnboardStatus(1)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(2)"></i>
                        <i class="fa fa-circle ball-active" aria-hidden="true" ng-click="setOnboardStatus(3)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(4)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(5)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(6)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(7)"></i>
            ...
            <span>
              Auto Buy Staking
                    ...
                    <p class="float-left fusion-text-14 intro-p col-md-12">
                        The auto-buy staking WebApp makes participating in Proof of Stake easier than ever. By using
                        Auto-buy, a user can just set-it and forget-it and seamlessly earn block rewards.
                    </p>
                    ...
                    <div class="col-md-12 p-2 text-center">
                        ...
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(2)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(3)"></i>
                        <i class="fa fa-circle ball-active" aria-hidden="true" ng-click="setOnboardStatus(4)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(5)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(6)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(7)"></i>
                    </div>
            ...
            <span>
              Short Account Number
                    ...
                    <p class="float-left fusion-text-14 intro-p col-md-12">
                        Generate a short account address which will make sending and receiving transactions easier,
                        interacting with other users simpler, reduce errors and increase the speed of blockchain
                        adoption. </p>
                    ...
                    <div class="col-md-12 p-2 text-center">
                        ...
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(3)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(4)"></i>
                        <i class="fa fa-circle ball-active" aria-hidden="true" ng-click="setOnboardStatus(5)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(6)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(7)"></i>
                    </div>
...
Learn about Time Lock
            ...
            <span>
              Time Lock
                    ...
                    <p class="float-left fusion-text-14 intro-p col-md-12">
                        MFW supports sending assets for a specified period of time with Time-Lock. When sending an
                        asset, you can choose timelock to “lend” or “loan” that asset out temporarily.</p>
                    ...
                    <div class="col-md-12 p-2 text-center">
                        ...
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(4)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(5)"></i>
                        <i class="fa fa-circle ball-active" aria-hidden="true" ng-click="setOnboardStatus(6)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(7)"></i>
                    </div>
...
Learn about Quantum Swap
            ...
            <span>
              Quantum Swap
                    ...
                    <div class="col-md-12 text-center">
                        <img src="images/q-swap.svg" alt="">
                    </div>

                    <p class="float-left fusion-text-14 intro-p col-md-12">
                        The Quantum Swap function enables users to exchange various digital assets seamlessly and securely with no added cost to the maker or taker.
                    </p>
                    <div class="col-md-12 p-2 text-center">
                        <i class="fa fa-circle ball-inactive"   aria-hidden="true" ng-click="setOnboardStatus(1)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(2)"></i>
                        ...
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(5)"></i>
                        <i class="fa fa-circle ball-inactive" aria-hidden="true" ng-click="setOnboardStatus(6)"></i>
                        <i class="fa fa-circle ball-active" aria-hidden="true" ng-click="setOnboardStatus(7)"></i>
                    </div>
                    <div class="col-md-12">
