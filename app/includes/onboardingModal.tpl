        ...
        <div class="modal-content">
            ...
            <span>
              Welcome to My Fusion Wallet (MFW)
                    ...
                    <div class="alert-yellow p-3">
                        <i class="fa fa-warning"></i>
                        <p class="intro-p">
                        MFW is only an interface to access your wallet. Double check all
            ...
            <span>
              Asset Lock-in
                    ...
                    <p class="float-left fusion-text-14 intro-p">FUSION’s Lock-in function enables assets from various blockchains to enter the FUSION ecosystem and access the complete functionality of the FUSION Protocol. </p>
