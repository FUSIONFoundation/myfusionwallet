        ...
        <div class="modal-content">
            ...
            <span>
              Welcome to My Fusion Wallet (MFW)
                    ...
                    <p class="float-left fusion-text-14">Learn more about MFW’s revolutionary new features:</p>
                        ...
                        <div class="col-xs-12 col-sm-8 onboarding__content">
                            <ul>
                                ...
                                <li translate="ONBOARD_bank_content__4">
                                    You can write a check or charge your debit card to send money, go online to check
                                    your balance, reset your password, and get a new debit card if you lose it.
                                </li>
                                <li translate="ONBOARD_bank_content__5">
                                    You have an account *with the bank* and they decide how much money you can send,
                                    where you can send it, and how long to hold on a suspicious deposit. All for a fee.
                                </li>
                            </ul>
                        </div>
                    </section>
