              ...
              Welcome to My Fusion Wallet (MFW)
                    ...
                    <div class="alert-yellow col-md-12">
                        <p class="intro-p">
                            ...
                            reversed. If your private keys are lost or stolen we cannot recover them for you or return
                            stolen
...
Learn about Quantum Swap
            ...
            <span>
              Quantum Swap
                    ...
                    <p class="float-left fusion-text-14 intro-p col-md-12">
                        The Quantum Swap function enables users to exchange various digital assets seamlessly and
                        securely with no added cost to the maker or taker.
                    </p>
                    <div class="col-md-12">
